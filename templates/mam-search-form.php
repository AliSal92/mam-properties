            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <select id="property_type" name="property_type" class="form-control">
                        ...
                        <?php foreach ($data['property_type'] as $option) { if(!$option) continue; ?>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <select id="status" name="status" class="form-control">
                        <option value=""><?php _e('Any', 'mam-properties'); ?></option>
                        <?php foreach ($data['status'] as $option) { if(!$option) continue;?>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <select id="bts" name="bts" class="form-control">
                        <option value=""><?php _e('Any', 'mam-properties'); ?></option>
                        <?php foreach ($data['bts'] as $option) { if(!$option) continue; ?>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <select id="location" name="location" class="form-control">
                        <option value=""><?php _e('Any', 'mam-properties'); ?></option>
                        <?php foreach ($data['location'] as $option) { if(!$option) continue; ?>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <select id="pricefrom" name="pricefrom" class="form-control">
                        <option value=""><?php _e('Any', 'mam-properties'); ?></option>
                        <?php foreach ($data['price-from'] as $key => $option) { if(!$option) continue; ?>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <select id="priceto" name="priceto" class="form-control">
                        <option value=""><?php _e('Any', 'mam-properties'); ?></option>
                        <?php foreach ($data['price-to'] as $key => $option) { if(!$option) continue; ?>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <select id="bedrooms" name="bedrooms" class="form-control">
                        <option value=""><?php _e('Any', 'mam-properties'); ?></option>
                        <?php foreach ($data['bedrooms'] as $option) { if(!$option) continue; ?>
